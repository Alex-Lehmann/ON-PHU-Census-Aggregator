...
setwd("") # Root directory of your COVID-19 case study project
...
unit_table = read_csv("data/censusmapper/ONPHU_HR2018_16_updated.csv", col_types=cols()) %>%
...
write.csv(province_data %>% arrange(Unit_ID), "") # Destination file for the census data